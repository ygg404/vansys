  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm"  label-width="110px">
      ...
      <el-form-item label="购置时间" prop="buyTime">
        <el-date-picker v-model="dataForm.buyTime" type="month" value-format="yyyy-MM" style="width: 130px;" placeholder="购置时间"></el-date-picker>
      </el-form-item>
      <el-form-item label="检定时间" prop="lastCheckTime">
        <el-date-picker v-model="dataForm.lastCheckTime" type="month" value-format="yyyy-MM" style="width: 130px;" placeholder="上次检修时间"></el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="仪器证书" prop="fileName">
        <el-upload :action="upDopFileUrl"
          ...
          <div slot="tip" style="color: dodgerblue" v-if="dataForm.fileName == null">
